...
$routes->plugin(
    ...
    function (RouteBuilder $builder): void {
        ...
        $builder->prefix('Admin', ['path' => '/baser/admin'], function (RouteBuilder $builder): void {
            $builder->connect('/passkeys/login_challenge',  ['controller' => 'Passkeys', 'action' => 'login_challenge']);
            $builder->connect('/passkeys/login',            ['controller' => 'Passkeys', 'action' => 'login']);
            $builder->connect('/passkeys/register_challenge', ['controller' => 'Passkeys', 'action' => 'register_challenge']);
            $builder->connect('/passkeys/register',         ['controller' => 'Passkeys', 'action' => 'register']);
